...
//        YarnJob job = new YarnJob(conf, "ModeleMapReduce Job");
...
//        job.addInputPath(new Path(args[0]));   /// VOIR ENTREES= DANS LE MAKEFILE
...
//        job.setOutputPath(new Path(args[1])); /// VOIR SORTIE= DANS LE MAKEFILE
//
...
//    }
    ...
    //au cas où YarnJob ne fonctionne pas, remplacer l'autre méthode par celle-ci
    @Override
    public int run(String[] args) throws Exception
    {
